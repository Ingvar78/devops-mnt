...

{
  ...
  "panels": [
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "(1-(node_memory_MemAvailable_bytes{job=\"nodeexporter\"}/node_memory_MemTotal_bytes{job=\"nodeexporter\"}))*100",
          "interval": "",
          "legendFormat": "",
          "refId": "A"
        }
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "(1 - ((node_filesystem_avail_bytes{mountpoint=\"/\",job=\"nodeexporter\"}) / node_filesystem_size_bytes{mountpoint=\"/\",job=\"nodeexporter\"}))*100",
          "interval": "",
          "legendFormat": "",
          "refId": "A"
        }
