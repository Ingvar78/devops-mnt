...
-Предлагается использовать следующие метрики:
    ...
    * Несколько метрик по HDD - свободное место и количество операций в секунду на чтение/запись, так же можно добавить количество использованных дескрипторов открытых файлов.
    ...
    * Метрики связанные с взаимодействием по http - количество и тип ошибок (4XX/5XX), процент положительных ответов на запросы, время ответа сервиса на запросы.
